export const routeurls = Object.freeze({
  ...
  LOCATION_BY_DATE: "/api/gpsdata",
  REVERSE_GEO: "/api/roads",
  DATA_BY_DATE_UID: "/api/gpsdata/reverse",
  ALL_USER_API: '/api/alluser',
  GPS_DATA_API: '/api/gpsdata',
  MY_ID_API: '/api/myid',
  LOGIN_API_BASE_URL: '/api/login',
  VOICE_SET_API: '/api/voice_set',
  GROUP_API: '/api/group',
